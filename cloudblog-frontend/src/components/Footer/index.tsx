        ...
        <div className="container">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <div className="flex items-center">
                    ...
                    <span className="text-primary ml-3 text-3xl font-bold">
                      CloudBlog
                    </span>
                  </div>
                </Link>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <p className="text-body-color dark:text-body-color-dark mb-4 text-base">
                  A modern cloud-based blogging platform where writers share
                  knowledge and readers discover insights.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              © {new Date().getFullYear()} CloudBlog. All rights reserved.
            </p>
          </div>
        </div>
